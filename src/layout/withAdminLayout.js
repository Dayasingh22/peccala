...
import { Div, SmallScreenAuthInfo, TopMenuSearch } from './style';
...
const ThemeLayout = WrappedComponent => {
  class LayoutComponent extends Component {
    ...
    render() {
      const { collapsed, hide, activeSearch } = this.state;
              ...
              <Row>
                <Col lg={!topMenu ? 4 : 3} sm={6} xs={12} className="align-center-v navbar-brand">
                  ...
                  <Link
                    ...
                    to="/admin"
                  >
                    <img src={require(`../static/img/Logo_Dark.svg`)} alt="logo" />
                  </Link>
                </Col>
              ...
              <Layout className="atbd-main-layout">
                <Content>
                  ...
                  <Footer className="admin-footer" style={footerStyle}>
                    <Row>
                      <Col md={12} xs={24}>
                        <span className="admin-footer__copyright">{new Date().getFullYear()} © Peccala</span>
                      </Col>
                      <Col md={12} xs={24}>
